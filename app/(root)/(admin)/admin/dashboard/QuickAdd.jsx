  ...
  return (
    <div className="grid lg:grid-cols-4 sm:grid-cols-2 sm:gap-10 gap-5 mt-10">
      <Link href={ADMIN_CATEGORY_ADD}>
        ...
        shadow bg-white dark:bg-card bg-gradient-to-tr from-green-400 via-green-500
        to-green-600"
        >
      ...
      <Link href={ADMIN_PRODUCT_ADD}>
        <div
          className="flex items-center justify-between p-3 rounded-lg
        shadow bg-white dark:bg-card bg-gradient-to-tr from-blue-400 via-blue-500
        to-blue-600"
        >
          <h4 className="font-medium text-white dark:text-black">
            Add Product
      ...
      <Link href={ADMIN_COUPON_ADD}>
        <div
          className="flex items-center justify-between p-3 rounded-lg
        shadow bg-white dark:bg-card bg-gradient-to-tr from-yellow-400 via-yellow-500
        to-yellow-600"
        >
      ...
      <Link href={ADMIN_MEDIA_SHOW}>
        <div
          className="flex items-center justify-between p-3 rounded-lg
        shadow bg-white dark:bg-card bg-gradient-to-tr from-cyan-400 via-cyan-500
        to-cyan-600"
        >
          <h4 className="font-medium text-white dark:text-black">
            Upload Media
